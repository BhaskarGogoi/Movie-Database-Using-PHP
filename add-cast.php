    ...
    <div class="container shadow mt-5 p-5">
        ...
        <div class="row">
            <?php
                ...
                echo "<h3>Add Casts to Movie - $row[mov_title]</h3>";
            ?>
            <div class="col-sm-12 mt-4">
                <div class="progress">
                    <div class="progress-bar bg-success" role="progressbar" style="width: 25%;" aria-valuenow="25"
                        aria-valuemin="0" aria-valuemax="100">1/4</div>
                </div>
            </div>
            <form id='form' action='includes/add-cast.php' method="post" class='form-center'>
                <div class="form-row">
                        ...
                        <div class="partners">
                            <div class="partner">
                                <table>
                                    <tr>
                                        <td><br>
                                            <select name="cast[]" id="partnerSelect" class="form-control">
                                                ...
                                                <?php 
                                                    ...
                                                    while($row = mysqli_fetch_array($result)) {
                                                        echo "
                                                        <option value='$row[act_id]'>$row[fname] $row[mname] $row[lname]</option>";
                                                    }
                                                ?>
                                            </select>
                                        </td>
                                        <td><input type="text" placeholder="Character" name="character[]"
                                                class="form-control mt-4 ml-3" required /></td>
