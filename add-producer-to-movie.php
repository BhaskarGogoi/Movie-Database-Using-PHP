<?php
	...
	echo "<title>Add Producer to Movie</title>";
?>
    ...
    <div class="container shadow mt-5 p-5">
        ...
        <div class="row">
            <?php
                ...
                echo "<h3>Add Producer to Movie - $row[mov_title]</h3>";
            ?>
            ...
            <form id='form' action='includes/add-producer-to-movie.php' method="post" class='form-center'>
                <div class="form-row">
                        ...
                        <div class="partners">
                            <div class="partner">
                                <table>
                                    <tr>
                                        <td><br>
                                            <select name="producer_id[]" id="partnerSelect" class="form-control">
                                                <option disabled selected value> -- select a producer -- </option>
                                                <?php 
                                                    $sql = "SELECT * FROM producer";
                                                                $result = $conn->query($sql);                                      
                                                    while($row = mysqli_fetch_array($result)) {
                                                        echo "
                                                        <option value='$row[producer_id]'>$row[fname] $row[mname] $row[lname]</option>";
                                                    }
                                                ?>
                                            </select>
                                        </td>
