...
<body class="main-layout">
    ...
    <div class="container shadow mt-5 p-5">
        ...
        <div class="row">
            <h3>Add Director</h3>
            <form action='includes/add-director.php' method="post" class='form-center'>
                <div class="form-row">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" name="office_phone" placeholder="Office Phone" required>
                    </div>
                </div>
